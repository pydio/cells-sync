...
import {
    ...
    CloudCircleOutlined, SwapVerticalCircleOutlined, TuneRounded, ArrowUpward, ArrowDownward
...
registerIcons({
    icons: {
        ...
        'CloudCircle':<CloudCircleOutlined style={{fontSize:'1em'}}/>,
        'Activities':<SwapVerticalCircleOutlined style={{fontSize:'1em'}}/>,
        'TuneRounded':<TuneRounded style={{fontSize:'1em'}}/>,
        ...
        'ArrowUp':<ArrowUpward style={{fontSize:'1em'}}/>,
        'ArrowDown':<ArrowDownward style={{fontSize:'1em'}}/>,
